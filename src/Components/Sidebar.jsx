...
const Sidebar = () => {
  ...
  return (
    <div className="w-[300px] fixed top-0 left-0 h-screen bg-sidebar flex-col
justify-between px-0 py-[2rem] hidden lg:flex z-40">
      <div className="top brand text-4xl flex p-4 text-primary font-family-marker gap-4 font-bold justify-center items-center
      text-2xl">
        <i className="bi bi-taxi-front-fill "></i>
        <h1 className='tracking-widest'>MY TAXI</h1>
      </div>
      <div className="middle absolute top-25">
        <div className="links  flex justify-center px-4 py-8">
      ...
      <div className="bottom flex justify-center items-center mx-4 logout">
